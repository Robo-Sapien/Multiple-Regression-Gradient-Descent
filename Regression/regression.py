...
class Regression:
	...
	def normal_equation(self):
		...
		output_val = np.matmul(parameters,self.x_train.transpose())

		error = self.error_estimation(output_val,2)
	...
	def gradient_descent_without_regularization(self,iterations,learning_rate):
		...
		while 1>0:
			...
			output_val = np.matmul(parameters,self.x_train.transpose())					
			curr_error = self.error_estimation(output_val,2)
			initial_parameters = parameters
	...
	def gradient_descent_with_rigged_regularization(self,iterations,learning_rate,reg_coeff):
		"""
...
if __name__ == '__main__':
	...
	error = reg.gradient_descent_with_rigged_regularization(0,0.0815,0.3)
	print("Rigged regression error =>" + str(error))	
	...
	#reg.gradient_descent_with_rigged_regularization(10000,0.001,1)
